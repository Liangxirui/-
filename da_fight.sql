...
CREATE TABLE `ord_form`  (
  ...
  CONSTRAINT `ord_form_ibfk_1` FOREIGN KEY (`o_id`) REFERENCES `object` (`o_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `ord_form_ibfk_2` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `review`  (
  ...
  CONSTRAINT `review_ibfk_1` FOREIGN KEY (`o_id`) REFERENCES `object` (`o_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `review_ibfk_2` FOREIGN KEY (`u_id`) REFERENCES `user` (`u_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
